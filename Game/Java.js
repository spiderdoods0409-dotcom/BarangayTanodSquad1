...
player1Sprites.idle.src = 'sprites/player2/idle.png';
player1Sprites.run.src = 'sprites/player2/Run.png';
player1Sprites.punch.src = 'sprites/player2/punch.png';
...
player2Sprites.idle.src = 'sprites/player1/idle.png';
player2Sprites.run.src = 'sprites/player1/Run.png';
player2Sprites.punch.src = 'sprites/player1/punch.png';
let imagesLoaded = 0;
...
class Fighter {
    ...
    if (!this.isPunching) {
        ...
        const hitboxX = this.x + this.width * 0.4; // Offset from left
        const hitboxY = this.y + this.height * 0.20; // Offset from top
...
const player2 = new Fighter(
    600,
    'green',
    { left: 'ArrowLeft', right: 'ArrowRight', punch: 'ArrowUp' },
    player2Sprites,
    player2Frames
);
player2.speed = 2; 
...
function drawHealthBars() {
    ...
    ctx.fillStyle = 'red';
    ctx.fillRect(50, 20, player1.hp * 3, 20); // 100 HP = 300px width
    ctx.strokeStyle = 'white';
    ctx.strokeRect(50, 20, 300, 20);

    ctx.fillStyle = 'white';
    ctx.font = '20px sans-serif';
    ctx.textAlign = 'left';
    ctx.fillText('Player 1', 50, 15);

    // Player 2 health bar (right)
    ctx.fillStyle = 'red';
    ctx.fillRect(canvas.width - 350, 20, player2.hp * 3, 20);
    ctx.strokeStyle = 'white';
    ctx.strokeRect(canvas.width - 350, 20, 300, 20);

    ctx.fillStyle = 'white';
    ctx.textAlign = 'right';
    ctx.fillText('Player 2', canvas.width - 50, 15);
}
...
function updatePlayer2AI() {
    ...
    if (player2.x > player1.x + player1.width) {
        ...
        if (!player2.isPunching && Math.random() < 10) {
